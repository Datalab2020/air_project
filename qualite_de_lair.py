...
tres = sns.catplot(y="lib_zone", x="val_pm10", kind="box", data=aggregation_index)



#dos = aggregation_index.describe(include='all')


"""
#pour faire plusieurs graphiques en même temps
plt.figure(figsize=(20, 16))
sns.relplot(x="date_ech", y="valeur", kind="line", hue="lib_zone", col="lib_zone", col_wrap=3,
            data=aggregation_index.query("date_ech >= '2020/01/01 00:00:00+00'"))
"""

#sns.catplot(y="lib_zone", x="valeur", kind="box", data=df)
